                  ...
                  <div className="ingr-grid">
                    {list.map((ing) => (
                      ...
                      >
                        ...
                        <span className="ingr-price">+€ {Number(ing.prezzoAggiunto || 0).toFixed(2)}</span>
                      </label>
                    ))}
                  </div>
                </div>
              ))}
              {!ingredienti.length && <div className="menu-empty">Nessun ingrediente disponibile al momento</div>}
            </div>
